...
class Weapon(Equipment):
    ...
    def attack(self,dealer,receiver):
        ...
        print dealer.name + " attacked for " + repr(damage) + " (-{})".format(round(damage * receiver.getArmorReduce()))
...
class SmallHealthPotion(Consumable):
    ...
    def use(self,target):
        ...
        print target.name + " gained 20 health! ({}/{})".format(target.health,target.getMaxHealth())
